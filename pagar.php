...
<body>
    ...
    <h2 style="text-align: center; font-size: 24px;">Pago de Orden</h2>
    ...
    <div style='text-align: center;'>
        <a href='index.html'>
            <img src='images/visa.jpg' alt='Procesar pedido' width='150 height='150'>
        </a>
        <a href='index.html'>
            <img src='images/mastercard.jpg' alt='Procesar pedido' width='150 height='150'>
        </a>
    </div>
